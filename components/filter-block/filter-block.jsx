...
const FilterBlock = ({ data, setMinPrice, setMaxPrice, brands, setBrands, setDataUpdated }) => {
    ...
    return (
        <div className="filter-block">
            ...
            <p
                className={lockedMinPrice || lockedMaxPrice ? 'btn-apply locked' : 'btn-apply'}
                onClick={() => !lockedMinPrice && !lockedMaxPrice ? setDataUpdated(true) : ''}>Применить</p>
        </div>
    );
};
